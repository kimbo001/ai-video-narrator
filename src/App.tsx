// src/App.tsx - FINAL VERSION: Public landing/play, protected generator only
...
/* ----------  PROTECTED ROUTE FOR GENERATOR ONLY ---------- */
const ProtectedGenerator: React.FC = () => {
  if (!clerkPubKey) {
    // No Clerk = allow access (dev mode)
...
/* ----------  LAYOUT WITH NAVIGATION (visible on all pages) ---------- */
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#0b0e14] text-zinc-300 font-sans selection:bg-cyan-500/30 flex flex-col">
      ...
      {/* Main content - no auth guard here */}
