    ...
    <nav className="border-b border-zinc-800 bg-[#0b0e14]/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="/" className="text-sm font-medium text-zinc-400 hover:text-white">Home</a>
          <a href="/pricing" className="text-sm font-medium text-zinc-400 hover:text-white">Pricing</a>
          <a href="/legal" className="text-sm font-medium text-zinc-400 hover:text-white">Terms & Privacy</a>
        </div>

        <div className="flex items-center gap-4">
          <a href="/generator" className="px-4 py-2 bg-white text-black text-sm font-bold rounded-lg hover:bg-zinc-200 transition-colors">
            App Dashboard
          </a>
        </div>
      </div>
    ...
    <footer className="border-t border-zinc-800 bg-[#0b0e14] py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          <a href="/legal" className="text-zinc-500 hover:text-zinc-300 text-sm">Privacy Policy</a>
          <a href="/legal" className="text-zinc-500 hover:text-zinc-300 text-sm">Terms of Service</a>
          <a href="/legal" className="text-zinc-500 hover:text-zinc-300 text-sm">Refund Policy</a>
  ...
  <BrowserRouter>
    <Layout>
      <Routes>
        <Route
          path="/"
          element={<LandingPage onStart={() => {}} onNavigate={(p) => (window.location.href = `/${p}`)} />}
        />
